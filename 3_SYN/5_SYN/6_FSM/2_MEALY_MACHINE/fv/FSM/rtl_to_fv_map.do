...
# Generated on: Wed Jul 08 05:31:24 KST 2026 (Tue Jul 07 20:31:24 UTC 2026)
...
set logfile fv/FSM/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/FSM -revised fv_map
...
add_search_path /home/hah013/Basic_SoC_Implementation/1_RTL/6_FSM/2_MEALY_MACHINE -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k /home/hah013/Basic_SoC_Implementation/1_RTL/6_FSM/2_MEALY_MACHINE/FSM.v
elaborate_design -golden -root {FSM} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/FSM/fv_map.v.gz
elaborate_design -revised -root {FSM}
...
#add_name_alias fv/FSM/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.FSM.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.FSM.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.FSM.rtl.fv_map.rpt
