...
# Generated on: Tue Aug 18 03:38:33 KST 2026 (Mon Aug 17 18:38:33 UTC 2026)
...
set logfile fv/d_latch_3/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/d_latch_3 -revised fv_map
...
add_search_path /home/hah013/Basic_SoC_Implementation/1_RTL/1_TASK/1_LOGIC_CIRCUIT/2_Seq_logic/4_D_latch -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k /home/hah013/Basic_SoC_Implementation/1_RTL/1_TASK/1_LOGIC_CIRCUIT/2_Seq_logic/4_D_latch/d_latch_3.v
elaborate_design -golden -root {d_latch_3} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/d_latch_3/fv_map.v.gz
elaborate_design -revised -root {d_latch_3}
...
#add_name_alias fv/d_latch_3/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.d_latch_3.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.d_latch_3.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.d_latch_3.rtl.fv_map.rpt
