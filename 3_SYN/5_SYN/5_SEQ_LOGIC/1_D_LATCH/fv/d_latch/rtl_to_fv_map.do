...
# Generated on: Wed Jul 08 04:55:30 KST 2026 (Tue Jul 07 19:55:30 UTC 2026)
...
set logfile fv/d_latch/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/d_latch -revised fv_map
...
add_search_path /home/hah013/Basic_SoC_Implementation/1_RTL/5_SEQ_LOGIC/1_D_LATCH -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k /home/hah013/Basic_SoC_Implementation/1_RTL/5_SEQ_LOGIC/1_D_LATCH/d_latch.v
elaborate_design -golden -root {d_latch} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/d_latch/fv_map.v.gz
elaborate_design -revised -root {d_latch}
...
#add_name_alias fv/d_latch/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.d_latch.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.d_latch.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.d_latch.rtl.fv_map.rpt
