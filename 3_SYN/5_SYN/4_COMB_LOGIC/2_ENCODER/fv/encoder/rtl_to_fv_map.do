...
# Generated on: Wed Jul 08 03:16:25 KST 2026 (Tue Jul 07 18:16:25 UTC 2026)
...
set logfile fv/encoder/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/encoder -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k ../../../../1_RTL/4_COMB_LOGIC/2_ENCODER/encoder.v
elaborate_design -golden -root {encoder} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/encoder/fv_map.v.gz
elaborate_design -revised -root {encoder}
...
set_system_mode lec
write_compared_points noneq.compared_points.encoder.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.encoder.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.encoder.rtl.fv_map.rpt
