...
# Generated on: Thu Jul 09 18:18:19 KST 2026 (Thu Jul 09 09:18:19 UTC 2026)
...
set logfile fv/counter6_down/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/counter6_down -revised fv_map
...
add_search_path /home/hah013/Basic_SoC_Implementation/1_RTL/2_TINY_PROJECT -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k /home/hah013/Basic_SoC_Implementation/1_RTL/2_TINY_PROJECT/counter6_down.v
elaborate_design -golden -root {counter6_down} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/counter6_down/fv_map.v.gz
elaborate_design -revised -root {counter6_down}
...
#add_name_alias fv/counter6_down/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.counter6_down.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.counter6_down.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.counter6_down.rtl.fv_map.rpt
