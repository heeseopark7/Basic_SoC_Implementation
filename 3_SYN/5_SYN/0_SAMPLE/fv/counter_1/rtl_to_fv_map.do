...
# Generated on: Wed Jul 08 02:05:55 KST 2026 (Tue Jul 07 17:05:55 UTC 2026)
...
set logfile fv/counter_1/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
set_system_mode lec
write_compared_points noneq.compared_points.counter_1.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.counter_1.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.counter_1.rtl.fv_map.rpt
