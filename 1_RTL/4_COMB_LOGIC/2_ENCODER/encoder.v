...
module encoder (
	// port list
	i_int, // incoming inturrupt
	i_int_ack, // CPU ack signal
	o_int_id, // encoded inturrupt ID
	o_int_req // inturrupt ID
...
reg [7:0] r_active_int		; //internal register

reg 	 	o_int_req	; //modeling
reg [2:0]	o_int_id	;
always @(*) begin
	o_int_req	= 1'b0	;
	o_int_id	= 3'b000;
